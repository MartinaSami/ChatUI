...
final User steven = User(
    ...
    imageUrl: 'assets/happy-man.png',
    isActive: false,
    storyImage:'assets/happy-man.pngg',
    isVideoCall : true,
...
List<User> calls = [dipak, joty, balram, tuktuk, steven, suvam, ayush, sophia,dipak, joty, balram, tuktuk, steven, suvam, ayush,sophia,sophia];
List<User> active = [
  dipa,
  dipak,
  suvam,
